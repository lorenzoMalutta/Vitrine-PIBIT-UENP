    ...
    return (
        <section className="sm:p-10 sm:m-10 m-5 font-medium">
            <div className="grid grid-cols-1 bg-white rounded shadow-md">
                <div>
                    <iframe className="w-full h-[600px]" src={"http://127.0.0.1:8000/storage" + software?.video} allow="autoplay" allowFullScreen />
                </div>
                ...
                <div className="grid sm:grid-cols-2 grid-cols-1 pl-10 pr-10 ">
                    ...
                    <div>
                        <h3>Imagem:</h3>
                        <img src={"http://127.0.0.1:8000/storage" + software?.image} alt="" />
                    </div>
                </div>
            </div>
        </section>
