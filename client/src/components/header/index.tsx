    ...
    <header className="grid h-max">
      <div className="grid grid-cols-2 p-2 bg-[#26448B]">
        ...
        <ul className="inline-flex items-center justify-end gap-2 text-2xl text-white ">
          ...
          <li onClick={onClick} className="sm:hidden">
            <AiOutlineMenu />
          </li>
          <li>
      ...
      <div className={ !isExpanded ? "sm:flex sm:justify-center text-center text-white bg-white drop-shadow-2xl sm:ml-40 sm:mr-40 rounded-md" : "hidden" }>
