        ...
        <section className="grid m-10">
            ...
            <div className="bg-white rounded-md shadow-md w-full">
                <form className="grid grid-cols-2 m-5 text-[#374151] text-xl font-bold" onSubmit={handleSubmit}>
                    ...
                    <div className="mt-2">
                        <p>Solução:</p>
                        <textarea placeholder="Mínimo de 255 caracteres máximo de 500 caracteres" className="shadow-md bg-[#F8FAFC]" name="solucao" id="solucao" cols={55} rows={5} value={solucao} onChange={(e) => setSolucao(e.target.value)} />
                    ...
                    <div className="mt-2">
                        <p>Problema:</p>
                        <textarea placeholder="Mínimo de 255 caracteres máximo de 500 caracteres" className="shadow-md bg-[#F8FAFC]" name="problema" id="problema" cols={55} rows={5} value={problema} onChange={(e) => setProblema(e.target.value)} />
                    ...
                    <div className="mt-2">
                        <p>Vantagem:</p>
                        <textarea placeholder="Mínimo de 255 caracteres máximo de 500 caracteres" className="shadow-md bg-[#F8FAFC]" name="vantagem" id="vantagem" cols={55} rows={5} value={vantagem} onChange={(e) => setVantagem(e.target.value)} />
